 ...
 * 
 */
package com.basic.framework.platform.basic.config;
...
@Configuration
@EnableJpaRepositories("com.basic.framework.platform.*.*")
...
public class HibernateSessionConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.basic.framework.platform.*.pojo");
